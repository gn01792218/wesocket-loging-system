<template>
    <div id="logPage" class="log-page scroll-auto">
      ...
      <div id="logBox" class="relative w-[90%] mx-auto flex flex-col justify-center">
        <img v-show="onScroll" class="fixed bottom-[10%] right-[10%] hover:opacity-70 hover:scale-95 animate-bounce" :src="getAssetsFileURL('images/toBottom.png')" alt="向下" @click="toBottom">
